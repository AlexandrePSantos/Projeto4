<?php
	...
	//check if can edit or redirect it
	$result = checkIfCanBeEdit( $_GET['cliente'], 'ID_Cliente', 'ID_Cliente', 1, 'faturacao_clientes' );
?>
<html>
	<title>Clientes: Editar Cliente | GESFaturação</title>
	<head>
										...
										<div id="form_div">
												...
												<div class="row">
													...
													<div class="col-md-2 hide">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="codigo_cliente" name="codigo_cliente" placeholder="..." disabled />
														</div>
													</div>
													<div class="col-md-2">
														<div class="form-group">
															<label class="control-label">Cód. Interno</label>
															<input type="text" class="form-control" id="codigo_interno_cliente" name="codigo_interno_cliente" placeholder="..." />
														</div>
													</div>
												</div>
												...
												<!-- <div class="row mtm">
													<div class="col-md-12">
														<div class="form-group">
															...
															<select class="form-control select2 show-tick" data-live-search="true"  data-header="Selecionar opção" id="grupo_cliente" name="grupo_cliente"  >
											...
											<div class="section-form">
												<div class="row">
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label">Conta Corrente?<span class="require">*</span></label>
															<div class="radio">
		...
		<script type="text/javascript">
			...
			$("#form_new").submit(function(e) {
				...
				if (valid == false) {
					...
					$.ajax({
						type : 'POST',
						url : '/gesfaturacao/server/clientes/editar.php',
						dataType : 'json',
						data : {
							idCliente : idCliente,
						...
						success : function(resposta) {
							...
							if (resposta == null)
								$.scojs_message("[FAT001] Ocorreu um erro ao atualizar os dados. Contacte o administrador", $.scojs_message.TYPE_ERROR);
							else {
								if (resposta.errors) {
									$.scojs_message("[FAT002] Ocorreu um erro ao atualizar os dados. Contacte o administrador", $.scojs_message.TYPE_ERROR);
								} else {
						...
						complete : function(resposta) {
							...
							if (resp.responseJSON.errors) {
								if (resp.responseJSON.nif_error) {
									...
									$.scojs_message("[FAT003] Ocorreu um erro ao atualizar os dados. Contacte o administrador", $.scojs_message.TYPE_ERROR);
								}
							} else {
								$.scojs_message("Dados atualizados com sucesso.", $.scojs_message.TYPE_OK);
								//reload
								setTimeout(function() {
                                    if(resp.responseJSON.new_user){
                                        window.location.href = "../clientes/detalhes?cliente="+resp.responseJSON.new_user;
                                    }else{
                                        window.location.href = "../clientes/detalhes?cliente="+idCliente;
                                    }
								}, 1000);
							}
