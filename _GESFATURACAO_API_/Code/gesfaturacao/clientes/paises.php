...
<option value="AX">Åland, Ilhas</option>
...
<option value="CF">Centro-Africana, República</option>
<option value="TD">Chade</option>
<option value="CZ">Checa, República</option>
<option value="CL">Chile</option>
<option value="CN">China</option>
<option value="CY">Chipre</option>
<option value="CX">Christmas, Ilha</option>
<option value="CC">Cocos, Ilhas</option>
<option value="CO">Colômbia</option>
<option value="KM">Comores</option>
<option value="CG">Congo, República do</option>
<option value="CD">Congo, República Democrática do</option>
<option value="CK">Cook, Ilhas</option>
<option value="KR">Coreia do Sul</option>
<option value="KP">Coreia, República Democrática da</option>
...
<option value="DO">Dominicana, República</option>
...
<option value="FO">Feroé, Ilhas</option>
...
<option value="GS">Geórgia do Sul e Sandwich do Sul, Ilhas</option>
...
<option value="GN">Guiné-Conacri</option>
<option value="GQ">Guiné Equatorial</option>
<option value="HT">Haiti</option>
<option value="HM">Heard e Ilhas McDonald, Ilha</option>
...
<option value="MK">Macedônia, República da</option>
...
<option value="FK">Malvinas, Ilhas</option>
<option value="IM">Man, Ilha de</option>
<option value="MP">Marianas Setentrionais</option>
<option value="MA">Marrocos</option>
<option value="MH">Marshall, Ilhas</option>
<option value="MQ">Martinica</option>
<option value="MU">Maurícia</option>
<option value="MR">Mauritânia</option>
<option value="YT">Mayotte</option>
<option value="UM">Menores Distantes dos Estados Unidos, Ilhas</option>
...
<option value="NF">Norfolk, Ilha</option>
...
<option value="SB">Salomão, Ilhas</option>
...
<option value="VG">Virgens Britânicas, Ilhas</option>
