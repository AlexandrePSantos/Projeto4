<html lang="pt">
	...
	<body id="signin-page">
		<div class="logo-div" align="center">
			<a href="/"><img src="/images/logo.png" style="max-width: 200px;"/></a>
		</div>
		<div class="logo-div" align="center">
			<h1 >404</h1>
			<h2>A página que procura não existe</h2>
			<div  class="text-center pal"><a href="javascript:history.go(-1)" class="btn btn-primary">Clique aqui para voltar</a></div>
		</div>
		<div id="smooth-footer">
			<div class="copyright">
				<a href="https://gesfaturacao.pt/" target="_blank"><img src="/img/ges-faturacao-white.png" style="width: 100px"/></a> <a href="//ftkode.com/" target="_blank">ftkode.com</a>
			</div>
		</div>
	</body>
</html>