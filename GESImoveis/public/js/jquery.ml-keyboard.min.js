(function($){
    ...
    KeyReturn.prototype.defaultClickAction = function() {
        if (this.keyboard.$current_input[0].id == 'search-input'){
            filterProdutos()
            closeKeyboard()
        }else if(this.keyboard.$current_input[0].id == 'search-input-vendas'){
            isSearch_vendas = true;
            filterVendas();
            closeKeyboard()
        }else if(this.keyboard.$current_input[0].id == 'search-input-clientes'){
            isSearch_clientes = true;
            filterClientes();
            closeKeyboard()
        }else if(this.keyboard.$current_input[0].id == 'search-input-movimentos'){
            isSearch_movimentos = true;
            filterMovimentos();
            closeKeyboard()
        }else if(this.keyboard.$current_input[0].id == 'saft_email'){
            saftExportSend();
            closeKeyboard()
        }
