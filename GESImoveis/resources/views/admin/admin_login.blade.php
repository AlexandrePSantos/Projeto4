			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">GES<span>Imoveis</span></a>
                    ...
                    <form class="forms-sample" method="post" action="{{ route('login') }}" >
                      ...
                      <div>
                        ...
                        <button type="submit" class="btn btn-outline-primary btn-icon-text mb-2 mb-mb-0">Login</button>
                      </div>
                      <a href="register.html" class="d-block mt-3 text-muted">Não tem conta? Registar</a>
                    </form>
                  </div>
                </div>
              </div>
